...
<div class="easyui-layout" data-options="fit:true, border:false"> 
	<div data-options="region:'center', border:false" title="" style="overflow:hidden;padding:10px;">
		<form id="form" method="post">
			<fieldset>
				<legend><img alt="" src="extend/fromedit.png" style="margin-bottom: -3px;">角色编辑</legend>
				<input name="roleId" id="roleId" type="hidden" />
				<input name="created" id="created" type="hidden" />
				<input name="creater" id="creater" type="hidden" />
				<input name="satus" id="status" type="hidden" />
				<table>
					<tr>
						<th>角色名称</th>
						<td><input name="name" id="name" placeholder="请输入角色名称" class="easyui-textbox easyui-validatebox" type="text" required="required" /></td>
						<th>排序</th>
						<td><input name="sort" class="easyui-textbox easyui-validatabox" id="sort" type="text" /></td>
					</tr>
					<tr>
						<th>描述</th>
