...
$(function() {
	 $dg = $("#dg");
	 $grid=$dg.datagrid({
		url : "log/logAction!findLogAllList.action",
		width : 'auto',
...
function delRows(){
	...
	if(row){
		...
		$.ajax({
			url:"log/logAction!delLogs.action",
...
function tbsCompanySearch() {
	jqueryUtil.gradeSearch($dg,"#tbCompanySearchFm","view/company/companySearchDlg.jsp");
}
</script>
</head>
<body>
