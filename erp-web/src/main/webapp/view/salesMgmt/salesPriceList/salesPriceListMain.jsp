					...
					<tr>
						<td>
							<shiro:hasPermission name="salPriceAdd">
								<a id="addOper" href="javascript:void(0);" class="easyui-linkbutton submain" iconCls="icon-add" plain="true" onclick="addSalesPriceListDlg();">添加</a>
							</shiro:hasPermission>
							<shiro:hasPermission name="salPriceMod">
								<a id="updOper" href="javascript:void(0);" class="easyui-linkbutton submain" iconCls="icon-edit" plain="true" onclick="updateSalesPriceListDlg();">修改</a>
							</shiro:hasPermission>
							<shiro:hasPermission name="salPriceDel">
								<a id="delOper" href="javascript:void(0);" class="easyui-linkbutton submain" iconCls="icon-remove" plain="true" onclick="delSalesPriceList();">删除</a>
							</shiro:hasPermission>
							<shiro:hasPermission name="salPriceShow">
								<a id="showOper" href="javascript:void(0);" class="easyui-linkbutton submain" iconCls="icon-show" plain="true" onclick="showSalesPriceListDlg();">查看</a>
							</shiro:hasPermission>
