...
<script type="text/javascript">
	...
	$(function(){
		...
		var entryArr = [[]];
		var currArr = [
		              {field:'quantity',title:'数量',sum:true,width:parseInt($(this).width()*0.05),editor:{type:'numberbox',options:{required:true}}},
		              {field:'price',title:'单价',width:parseInt($(this).width()*0.05),editor:{type:'numberbox',options:{precision:2,required:true}}},
