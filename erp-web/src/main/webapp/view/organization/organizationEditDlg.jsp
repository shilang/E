...
<script type="text/javascript">
	$(function(){
		$("#iconCls").combobox({
			...
			data: $.iconData,
			formatter: function(){
				return $.formatString('<span class="{0}" style="display: inline-block; vertical-align:middle;width: 16px; height:16px;"></span>{1}',
				v.value, v.value);
			}
		});
		$("#pid").combotree({
			...
			<fieldset>
				...
				<table>
					...
					<tr>
						...
						<th>简称</th>
						<td><input id="shorName" id="shorName" type="text" class="easyui-textbox easyui-validatebox"/></td>
					</tr>
					<tr>
						<th>上层组织</th>
