...
<script type="text/javascript">
	...
	$(function(){
		...
		var currArr = [
		               ...
		               {field:'price',title:'单价',width:parseInt($(this).width()*0.06),editor:{type:'numberbox',options:{precision:4,required:true}}},
		               {field:'amount',title:'金额',sum:true,width:parseInt($(this).width()*0.06),editor:{type:'numberbox',options:{precision:4,required:true}}},
		               {field:'settleQty',title:'结算数量',sum:true,width:parseInt($(this).width()*0.06),editor:{type:'numberbox',options:{required:true}}},
		               {field:'settleAmount',title:'结算实收金额',sum:true,width:parseInt($(this).width()*0.08),editor:{type:'numberbox',options:{precision:4,required:true}}},
