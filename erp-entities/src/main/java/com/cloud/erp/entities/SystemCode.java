...
public class SystemCode implements Serializable{
	...
	public SystemCode(String codeMyid, String name,
			Integer sort, String iconCls, String state, String type,
			Integer parentId, Integer permissionId, String description,
